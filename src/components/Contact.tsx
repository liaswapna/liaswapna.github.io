...
export function Contact() {
  ...
  return (
    <section
      ...
      style={{ background: Theme.contactGradient() }}
    >
      <div className="max-w-2xl mx-auto text-center">
        <p className="font-mono text-xs tracking-widest uppercase mb-2" style={{ color: c.teal }}>
          Let's Connect
        </p>
        <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: c.white }}>
          Get In Touch
        </h2>
        <p className="leading-relaxed mb-10" style={{ color: c.mint }}>
          I'm looking for my next role as a Software Developer. If you have an opportunity,
          a question, or just want to connect, I'd love to hear from you.
        </p>
        <div className="flex justify-center gap-4">
          <a
            href="https://www.linkedin.com/in/swapna-lia-anil/"
            target="_blank"
            rel="noreferrer"
            aria-label="LinkedIn"
